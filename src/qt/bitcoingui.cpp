...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a nexus address"));
    ...
    aboutAction->setStatusTip(tr("Show information about nexus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for nexus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nexus addresses to prove you own them"));

    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nexus addresses"));
...
void BitcoinGUI::blocksIconClicked()
{
    ...
    message(tr("Extended Block Chain Information"),
        tr("Client Version: %1\n"
           ...
           .arg(tr("5.0000000")) // Hard Coded as NXS is always 5, but should use GetProofOfWorkReward
    ...
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            walletStack->gotoSendCoinsPage();
             ...
             message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid nexus address or malformed URI parameters."),
